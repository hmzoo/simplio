...
},{"./views/mainview.jsx":35}],35:[function(require,module,exports){
...
var simpleChat = ReactDOM.render(
  React.createElement(SimpleChat, {onJoinRoom: joinRoom, onSendMessage: sendMessage}), document.getElementById('chat'));



module.exports = mainView;

},{"./simplechat.jsx":36,"react":33}],36:[function(require,module,exports){
var React = require('react');

//ROOM INPUT
var JoinRoomInput = React.createClass({displayName: "JoinRoomInput",
    getInitialState: function() {
        return {textValue: ''}
    },
...
//MESSAGING
var SendMessageInput= React.createClass({displayName: "SendMessageInput",
    getInitialState: function() {
        return {textValue: ''}
    },
        ...
        return (
            React.createElement("div", {id: "textbox"}, 
              this.props.datas.map(function(result){
                console.log(result);
                return (
                  React.createElement("div", {key: result.id}, React.createElement("b", null, result.user, " : "), result.content)
                );
              })
            )
        );
    ...
    render: function() {
        return (
            React.createElement("div", {id: "listbox"}, React.createElement("h6", null, "U"), 
              this.props.datas.map(function(result){
                return (
                  React.createElement("div", {key: result.name}, React.createElement("b", null, result))
                );
              })
            )
        );
    ...
    render: function() {
        return (
          React.createElement("div", null, 
            React.createElement("div", {className: "grid "}, 
                React.createElement("div", {className: "grid-item 2/12 "}, React.createElement("h3", {className: "wrapper"}, this.state.userName), "  "), 
                React.createElement("div", {className: "grid-item 2/12 wrapper"}, React.createElement("h2", {className: "wrapper"}, this.state.roomName)), 
                React.createElement("div", {className: "grid-item 4/12 wrapper"}, React.createElement("div", {className: "wrapper"}, this.state.infos)), 
                React.createElement("div", {className: "grid-item 4/12"}, React.createElement("div", {className: "wrapper"}, React.createElement(JoinRoomInput, {onSubmit: this.props.onJoinRoom})))
            ), 
            React.createElement("div", {className: "grid "}, 
              React.createElement("div", {className: "grid-item 8/12"}, 
                React.createElement(MessagesBox, {datas: this.state.messages}), 
                React.createElement("div", {className: "wrapper"}, React.createElement(SendMessageInput, {onSubmit: this.props.onSendMessage}))

                ), 
                React.createElement("div", {className: "grid-item 8/12"}, 
                  React.createElement(UsersList, {datas: this.state.users})
                )
            )
