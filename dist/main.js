                        ...
                        React.createElement("div", {className: "grid-item 4/12 bord"}, 
                            ...
                            React.createElement("div", {className: "grid gutter-0 ", id: "joinroom"}, 
                                React.createElement("form", {action: "", onSubmit: this.handleSubmitRoomForm}, 
                                    React.createElement("div", {className: "grid-item 8/12 bord"}, 
                                        React.createElement("input", {id: "msginput", className: "form-input wrapper", type: "text", placeholder: "Room name", onChange: this.onChangeRoomInput})
                                    ), 
                                    React.createElement("div", {className: "grid-item 4/12 bord"}, 
                            ...
                            React.createElement("div", {id: "sendmessage"}, 
                                React.createElement("div", {className: "grid gutter-0 ", id: "sendmessage"}, 
                                    React.createElement("form", {action: "", onSubmit: this.handleSubmitMessageForm, autoComplete: "off"}, 
                                        React.createElement("div", {className: "grid-item 10/12 bord"}, 
                                            React.createElement("input", {id: "msginput", className: "form-input wrapper", type: "text", placeholder: "Type here", autoComplete: "off", onChange: this.onChangeMessageInput})
                                        ), 
                                        React.createElement("div", {className: "grid-item 2/12 bord"}, 
