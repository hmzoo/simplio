...
var simpleChat = ReactDOM.render(
  React.createElement(SimpleChat, {onJoinRoom: test}), document.getElementById('chat'));
    ...
    render: function() {
        return (
            React.createElement("div", {className: "grid"}, 
                ...
                React.createElement("div", {className: "grid-item 4/12"}, 
                    React.createElement("h3", null, this.props.roomName)
                ), 
                React.createElement("div", {className: "grid-item 4/12"}, 
                    this.props.infos
                )
...
//ROOM INPUT
JoinRoomInput = React.createClass({displayName: "JoinRoomInput",
    getInitialState: function() {
        return {textValue: ''}
    },
    ...
    render: function() {
        return (
            React.createElement("div", null, 
                React.createElement("div", null, 
                    React.createElement(InfoBox, {userName: this.state.userName, roomName: this.state.roomName, infos: this.state.infos})
                ), 
                React.createElement("div", null, 
                    React.createElement(JoinRoomInput, {onJoinRoom: this.props.onJoinRoom})
                )
            )
